...
//     isActive
//       ? 'text-white font-semibold px-4 py-2 rounded-md bg-[#E67327]'
//       : 'text-white px-4 py-2 rounded-md transition-colors duration-200 hover:bg-[#FF7A00]';

//   return (
//     <nav className="bg-[#FF8C42] fixed top-0 w-full z-50 shadow-sm">
...
//         {/* Mobile Menu */}
//         {menuOpen && (
//           <div className="md:hidden mt-2 space-y-1 bg-[#FFF4E0] p-4 rounded-md shadow">
//             <NavLink
//               to="/"
//               className={({ isActive }) =>
//                 isActive
//                   ? 'block px-4 py-2 rounded-md bg-[#FF7A00] text-white font-semibold'
//                   : 'block px-4 py-2 rounded-md text-gray-800 hover:bg-[#FF8C42] hover:text-white transition-colors'
//               }
